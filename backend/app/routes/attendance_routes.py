...
def check_in(current_user: user_db.User = Depends(get_active_user), db: Session = Depends(get_db)):
    """
    API Endpoint: Clocks the user in.
    """
...
def check_out(current_user: user_db.User = Depends(get_active_user), db: Session = Depends(get_db)):
    """
    API Endpoint: Clocks the user out.
    """
...
def get_today_status(current_user: user_db.User = Depends(get_active_user), db: Session = Depends(get_db)):
    """
    API Endpoint: Gets the current day's attendance status.
    """
...
def get_my_history(current_user: user_db.User = Depends(get_active_user), db: Session = Depends(get_db)):
    """
    API Endpoint: Retrieves the user's attendance history.
    """
...
def get_all_attendance(current_user: user_db.User = Depends(get_active_user), db: Session = Depends(get_db)):
    """
    API Endpoint: Retrieves all company attendance records.
    """
